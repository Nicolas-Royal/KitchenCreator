...
## Corpus Check
- 37 files · ~2,660,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 512 nodes · 1097 edges · 33 communities (30 shown, 3 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d41aa887`
...
- `validarFila()` --indirect_call--> `campo()`  [INFERRED]
  royal-catalog-creator-pitch/plugin-demo/js/app.js → test/reglas.test.js
...
### Community 7 - "Barra lateral del diálogo (lista de módulos y acciones)"
Cohesion: 0.20
Nodes (10): El diálogo corre sobre el CEF de SketchUp, Carpeta «Main Components» con los tres modelos base, La tabla de revisión usa controles propios, La plantilla se descarga sin selector de ruta, Modal de confirmación genérico (#modal-confirm), Panel de revisión de importación (#pane-import), Barra lateral del diálogo (lista de módulos y acciones), Componente base siempre desde archivo, nunca desde la escena (+2 more)
...
### Community 11 - "Carpeta del proyecto (contiene «Main Components»)"
Cohesion: 0.20
Nodes (10): Carpeta del proyecto (contiene «Main Components»), Regla de cajones implementada dos veces (app.js y main.rb), Riesgos operativos y mitigación, Clonar módulo para producir variaciones, La salida se sobrescribe sin versionar, Vía visual — captura módulo por módulo, «Generar todos» — cola secuencial con cancelación por unidad, registro_id en el payload y en todas las respuestas de generar (+2 more)
...
### Community 14 - "Presupuesto de alto de cajones"
Cohesion: 0.40
...
Cohesion: 0.29
Nodes (7): importer.rb — parseo estructural de CSV/XLSX, xlsx.rb — lector/escritor mínimo de .xlsx sin gems, Catálogo de mensajes y solución de problemas, Tope de 500 filas por importación, Detección de CSV en Windows-1252, Escritura de .xlsx sin gems (zip sin comprimir, cadenas inline), Bitácora de decisiones fechadas
